...
$udp set dst_port_ 0
set rcvr1 [new Agent/LossMonitor] ; #reciever agent at node 1
$ns attach-agent $n1 $rcvr1
$ns at 1.9 "$n1 join-group $rcvr1 $group"
set rcvr2 [new Agent/LossMonitor] ; #reciever agent at node 2
$ns attach-agent $n2 $rcvr2
$ns at 1.12 "$n2 join-group $rcvr2 $group"
set rcvr3 [new Agent/LossMonitor] ; #reciever agent at node 3
$ns attach-agent $n3 $rcvr3
$ns at 1.15 "$n3 join-group $rcvr3 $group"
set rcvr4 [new Agent/LossMonitor] ; #reciever agent at node 4
